...
dagshub.init(repo_owner='rishavkumar1951', repo_name='swiggy-delivery-time-prediction', mlflow=True)


# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/rishavkumar1951/swiggy-delivery-time-prediction.mlflow")
...
models = client.search_model_versions("name='delivery_time_pred_model'")
...
client.transition_model_version_stage(
    ...
    version=3,  # Change this to the actual version number
    stage="Production"
)

client.transition_model_version_stage(
    name="delivery_time_pred_model",
    version=1,  # Change this to the actual version number
    stage="staging"
)

# updated_model = client.get_model_version("delivery_time_pred_model", 1)
# print(f"Model version {updated_model.version} is now in '{updated_model.current_stage}' stage.")
